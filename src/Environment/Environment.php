...
final class Environment implements ConfigurableEnvironmentInterface
{
    ...
    /**
     * @var PrioritizedList<BlockParserFactoryInterface>
     */
    private $blockParserFactories;
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->blockParserFactories = new PrioritizedList();
    ...
    {
        $this->assertUninitialized('Failed to add block parser factory.');

        $this->blockParserFactories->add($factory, $priority);
        $this->injectEnvironmentAndConfigurationIfNeeded($factory);
    ...
    public function getBlockParserFactories(): iterable
    {
        ...
        return $this->blockParserFactories->getIterator();
    }
